...
// // create map obj
// const map = initMap();
// http://127.0.0.1:8000/maritimeapp/measurements/?format=json&level=15&page=2&reading=aod&type=series
// getData('?format=json&level=15&page=1&reading=aod&type=series')
// console.log(x)
// let args;
